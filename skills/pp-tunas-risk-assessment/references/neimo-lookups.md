...
This file is the *method* for grounding the assessment. The values neimo. returns
are the *answers*. Never substitute the illustrative numbers below for a live
lookup — they exist only so you know which question each lookup answers.
