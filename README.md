...
| `regulation-tutor` | Personalized tutor for online-safety and children's-privacy regulation. Runs intake, then teaches turn by turn from live neimo. MCP results — as an interactive explorer, guided conversation, presentation, quiz, or cheat-sheet — always citing sources. Use when the user wants to learn or be trained on youth-safety / kids-privacy rules. |
